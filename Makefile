...
CC = clang
# default flags
CFLAGS= -c -I include --target=i686-pc-none-elf -ffreestanding -fno-builtin -nostdlib -nostdinc++ -march=i686 -fdiagnostics-color
# set gdb
...
kcore/kernel_main.bin: kcore/kernel_entry.o ${OBJ}
	ld.lld -z muldefs -o $@ -Ttext 0x7e00 $^ --oformat binary -z notext
